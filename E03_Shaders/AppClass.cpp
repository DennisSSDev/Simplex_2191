...
{
	m_uShaderProgramID = LoadShaders("Shaders//BasicColor.vs", "Shaders//InvertedColor.fs");
...
void AppClass::Display(void)
{
	...
	GLuint InvertParam = glGetUniformLocation(m_uShaderProgramID, "InvertColor");
	glUniform1i(InvertParam, compColor);
